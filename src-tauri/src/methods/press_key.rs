...
pub fn press_key_multiple_times(key_str: &str, count: u32, interval_ms: Option<u64>) -> Result<String, String> {
        ...
        match key_str.to_lowercase().as_str() {
            ...
            | "right" | "down" => {
                let vk = match key_str.to_lowercase().as_str() {
                    ...
                    "up" => 0x26, "right" => 0x27, "down" => 0x28, _ => 0,
                };
...
unsafe fn send_native_scancode(vk: u16, is_down: bool, extended: bool) {
    ...
    let input = INPUT {
        ...
        Anonymous: INPUT_0 {
            ki: KEYBDINPUT {
                wVk: VIRTUAL_KEY(0), wScan: scan_code, dwFlags: flags, time: 0, dwExtraInfo: 0,
            },
        },
    };
